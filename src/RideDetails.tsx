    ...
    <View style={tw`w-full h-16  mt-3 justify-between items-center`}>
      <View style={tw`flex-row justify-between w-full`}>
        <View style={tw`flex-row items-center`}>
          <View style={tw`h-4 w-4 rounded-2xl bg-[#04825C] mr-2.5`} />
          <Text style={tw`font-normal text-base`}>{props.pickup_location}</Text>
        </View>
        <Text style={tw`text-[#0057FF] font-normal text-base`}>Edit</Text>
      </View>
      <View style={tw`flex-row justify-between w-full`}>
        <View style={tw`flex-row items-center`}>
          <View style={tw`h-4 w-4 rounded-2xl bg-[#EA1D1D] mr-2.5`} />
