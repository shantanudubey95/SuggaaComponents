...
export const CURENT_LOCATION = require('../../assets/currentLocation.png');
...
export const PAYEMNT = require('../../assets/payment.png');
export const INCURANCE = require('../../assets/insurance.png');
