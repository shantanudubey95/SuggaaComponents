...
export function BookingScreen() {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <BottomModal showModal={state.showModal} height={'80%'} onClose={() => dispatch({ type: 'showModal', payload: false })}>
                <VehicleWithFareCard vehicleType='HATCH' duration={"0"} fare={120} onPress={() => alert('onPress')} />
                <VehicleWithFareCard vehicleType='SEDAN' duration={"0"} fare={120} onPress={() => alert('onPress')} />
                <VehicleWithFareCard vehicleType='RICKSHAW' duration={"0"} fare={120} onPress={() => alert('onPress')} />
                <VehicleWithFareCard vehicleType='BIKE' duration={"0"} fare={120} onPress={() => alert('onPress')} />
                <VehicleWithFareCard vehicleType='SCOOTER' duration={"0"} fare={120} onPress={() => alert('onPress')} />
