...
const Payments = () => {
  return (
    <View>
      ...
      <TextBold22 text="This font is size 22 BOLD" />
      <TextBold20 style={tw`text-red-700`} text="This font is size 20 BOLD" />
      <TextBold18 style={tw`text-yellow-700`} text="This font is size 18 BOLD" />
      <TextBold15 text="This font is size 15 BOLD" />
      <TextBold12 text="This font is size 12 BOLD" />
      <TextSemiBold22 text="This font is size 22 semibold" />
      <TextSemiBold20 text="This font is size 20 semibold" />
      <TextSemiBold18 text="This font is size 18 semibold" />
      <TextSemiBold15 text="This font is size 15 semibold" />
      <TextSemiBold12 text="This font is size 12 semibold" />
      <TextMedium22 text="This font is size 22 medium" />
      <TextMedium20 text="This font is size 20 medium" />
      <TextMedium18 text="This font is size 18 medium" />
      <TextMedium15 text="This font is size 15 medium" />
      <TextMedium12 text="This font is size 12 medium" />
      <TextRegular22 text="This font is size 22 regular" />
      <TextRegular20 text="This font is size 20 regular" />
      <TextRegular18 text="This font is size 18 regular" />
      <TextRegular15 text="This font is size 15 regular" />
      <TextRegular12 text="This font is size 12 regular" />
    </View>
  );
};
